    ...
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`w-full px-3.5 py-2.5 rounded-xl border text-left flex items-center justify-between transition-all font-medium text-sm ${
          hasError
            ? 'border-red-500 bg-red-50/30 text-red-900 ring-2 ring-red-200'
            : isOpen
            ? 'border-orange-500 bg-white ring-2 ring-orange-500/20'
            : selectedCountry
            ? 'border-slate-300 bg-white text-[#0B192C] hover:border-slate-400'
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          {selectedCountry ? (
            <>
              ...
              <span className="truncate font-bold text-[#0B192C]">
                {lang === 'so' && selectedCountry.nameSo ? selectedCountry.nameSo : selectedCountry.name}
              </span>
              <span className="px-2 py-0.5 rounded-md bg-orange-100 text-orange-800 text-xs font-black shrink-0">
      ...
      {isOpen && (
        <div className="absolute z-50 left-0 right-0 top-full mt-1.5 bg-white rounded-2xl border-2 border-orange-500 shadow-2xl overflow-hidden animate-fadeIn">
          ...
          <div className="p-2.5 bg-slate-50 border-b border-slate-200">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-8 py-2 bg-white rounded-xl border border-slate-300 text-xs sm:text-sm font-medium focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              />
              {searchQuery && (
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-[11px] text-slate-500 font-semibold mt-1.5 px-1">
                  ...
                  <button
                    ...
                    className={`w-full px-3 py-2.5 rounded-xl text-left flex items-center justify-between transition-colors text-xs sm:text-sm cursor-pointer ${
                      isSelected
                        ...
                        : 'hover:bg-slate-100 text-[#0B192C] font-semibold'
                    }`}
                  >
                    <div className="flex items-center gap-2.5 min-w-0">
