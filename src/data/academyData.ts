...
export const COURSES_DATA: Course[] = [
  ...
  },
  {
    ...
    featuresSo: [
      'Hab waxbarasho oo xiiso leh oo ku habboon carruurta qurbaha',
      'Buugaagta manhajka oo bilaash ah (PDF & interactive)',
      'Kalfadhiyo su’aalo iyo jawaabo ah oo toos ah'
    ],
    featuresEn: [
      'Engaging, interactive methods suited for diaspora youth',
...
export const PRICING_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    subtitleSo: 'Xirmo isu-dheellitiran oo u wanaagsan horumar degdeg ah.',
...
export const TESTIMONIALS_DATA: Testimonial[] = [
  {
    ...
    countryCode: 'GB',
    commentSo: 'Ilaahay baa mahad leh, carruurtaydu waxa ay halkan ka bilaabeen Qaacidada Nuuraaniyada, haddana waxa ay si qurux badan oo Tajwiid ah u akhrinayaan Suuradaha waaweyn. Macallimiintu waa kuwo sabir badan oo yaqaanna sida carruurta qurbaha loola dhaqmo.',
    commentEn: 'Alhamdulillah, my kids started from Noorani Qaida and are now reciting long Surahs with beautiful Tajweed. The teachers are incredibly patient, punctual, and truly understand how to engage diaspora children.',
    rating: 5,
    date: '15 Feb 2025',
